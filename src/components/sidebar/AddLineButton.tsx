 ...
 * segment does it in one click, and adding a real route stays one click away in
 * the second segment rather than competing for space as a second full-width button.
 *
 * That segment shows an ellipsis rather than a caret on purpose — a caret promises
 * a dropdown, and searching real networks needs a modal.
 */
export function AddRouteButton() {
  ...
  return (
    <>
      ...
      <AddRouteModal open={isAddOpen} onClose={() => setIsAddOpen(false)} />
    </>
  );
}
